...
export default function Navbar() {
  ...
  return (
    <nav className="bg-slate-400 flex justify-between items-center py-3 px-10 shadow-md shadow-slate-500 fixed top-0 right-0 left-0">
      <NavBrand />
      <span
      ...
      <div
        className={`md:flex md:justify-end md:static md:py-0 py-5 absolute gap-3 md:z-auto z-[-3] md:opacity-100 opacity-0 bg-slate-400 w-full left-0 ${
          opened
            ? "md:translate-y-0 translate-y-[150px] opacity-100"
