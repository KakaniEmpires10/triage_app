  ...
  return (
    <>
      <div className="bg-white shadow p-7 rounded-lg space-y-5">
        ...
        <TableUser openModal={() => setShowModalAdd(true)} openDetail={() => setShowModalDetail(true)} />
      </div>
      <Modal isVisible={showModalAdd} onClose={() => setShowModalAdd(false)} title={"Tambah User"}>
        <ModalCreateUser onNext={() => showModalAdd(false)} />
      </Modal>
      <Modal isVisible={showModalDetail} onClose={() => setShowModalDetail(false)} title={"Edit User"}>
